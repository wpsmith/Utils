...
if ( ! class_exists( __NAMESPACE__ . '\Inflect' ) ) {
	class Inflect {
		...
		protected static function is_uncountable( $string ) {

			return in_array( strtolower( $string ), self::$uncountable );
